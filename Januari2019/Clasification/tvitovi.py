...
if __name__ == '__main__':
    ...
    testCase = train_data[index]

    predvid = cl.classifyDocument(testCase[1])

    print("Pozitivni primeri: ", int(cl.getCategoryCount('positive')), "Negativni primeri: ", int(cl.getCategoryCount('negative')))
    print("Index:", index, ",Tocna klasa:", testCase[0], ",Predvidena:", predvid, ",Sozdrzina:", testCase[1])
